...
def test_check_email_success():
    ...
    response = client.post(f"/api/v1/tools/email-validation?email_address={valid_address}")
...
def test_check_email_failure():
    ...
    response = client.post(f"/api/v1/tools/email-validation?email_address={invalid_address}")
